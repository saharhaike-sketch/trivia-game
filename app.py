...
# --- עיצוב האולפן, סרגל הצד ויישור לימין ---
def set_studio_design():
    st.markdown(
        """
        <style>
        /* יישור לימין של כל האפליקציה וסידור סימני הפיסוק */
        .stApp, .block-container, div, p, h1, h2, h3, h4, span, button {
        ...
        /* רקע אולפן כחול-שחור */
        .stApp {
            background: radial-gradient(circle at 50% 50%, #1e3c72 0%, #030a1c 60%, #000000 100%);
        }
        
        /* עיצוב סרגל הצד */
        [data-testid="stSidebar"] {
            background: linear-gradient(180deg, #030a1c 0%, #000000 100%) !important;
            border-left: 2px solid #ce9b2c;
        }
        [data-testid="stSidebar"] * {
        ...
        .block-container {
            ...
            box-shadow: 0 0 30px rgba(206, 155, 44, 0.3);
            margin-top: 2rem;
        }
...
# מאגר השאלות עם רמזים מותאמים אישית (חבר טלפוני)
ALL_QUESTIONS = [
